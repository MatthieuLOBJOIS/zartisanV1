...
final class Version20191129141101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD mail_token VARCHAR(255) DEFAULT NULL, ADD is_confirm_mail TINYINT(1) NOT NULL, ADD is_status TINYINT(1) NOT NULL, ADD firstname VARCHAR(255) DEFAULT NULL, ADD lastname VARCHAR(255) DEFAULT NULL, ADD birthday DATE DEFAULT NULL, ADD company VARCHAR(255) DEFAULT NULL, ADD company_description LONGTEXT DEFAULT NULL, ADD naf VARCHAR(50) DEFAULT NULL, ADD adress_supp VARCHAR(255) DEFAULT NULL, ADD special_distribution VARCHAR(50) DEFAULT NULL, ADD ext_number_way VARCHAR(50) DEFAULT NULL, ADD number_way INT DEFAULT NULL, ADD type_way VARCHAR(50) DEFAULT NULL, ADD way VARCHAR(255) DEFAULT NULL, ADD postal_code VARCHAR(50) DEFAULT NULL, ADD city VARCHAR(255) DEFAULT NULL, ADD phone VARCHAR(10) DEFAULT NULL, ADD is_verified TINYINT(1) NOT NULL, ADD picture VARCHAR(255) DEFAULT NULL, ADD picture_folder JSON DEFAULT NULL, ADD region VARCHAR(255) DEFAULT NULL, ADD average_rate INT DEFAULT NULL, ADD is_reported TINYINT(1) NOT NULL, ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
    }
