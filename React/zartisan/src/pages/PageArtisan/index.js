						...
						<Row>
							<div className="page-artisan-description">
								<Row>
									<div>
										<div id="companyName">
											<Tooltip placement="bottom" title="Nom de l'entreprise">
								...
								<div className="artisan-description">
									<Row>
										<Col span={12}>
											<div>
												<Tooltip placement="left" title="Avatar de l'artisan">
													<img
										...
										<Col span={12}>
											<div className="description-info">
												<div>
													Adresse: {artisanObject.numberWay} {artisanObject.typeWay}{' '}
